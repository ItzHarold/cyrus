...
### Fixed
- **Writing on your issue while we are working no longer restarts anything on your side.** You get a short acknowledgement, and your words go to the reviewer. Previously a message mid-work could start a second, unreviewed run on your own thread.
