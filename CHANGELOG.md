...
### Fixed
- **A clarifying question asked before a scope is proposed no longer vanishes from the operator's waiting list.** When the agent asks a client something before it can propose a scope, that conversation now shows up as waiting; previously it was invisible until the client answered.
