...
### Fixed
- **The cockpit's waiting list no longer keeps a stale row after it closes.** When the last waiting conversation was answered, the list closed but still showed that conversation as waiting; it now empties itself first.
