...
### Fixed
- **The agent's checklist now shows in the session panel.** The step-by-step plan was sent in a shape the platform refuses, so it never rendered for anyone; it now does.
